    ...
    <section className="space-y-6 pb-8 md:pb-12 md:pt-10 lg:py-32">
      <div className="container mt-6 flex max-w-5xl flex-col items-center gap-4 text-center xl:mt-0">
        ...
        <h1 className="text-3xl capitalize sm:text-5xl md:text-6xl lg:text-7xl">
          ...
          <span className="font-code bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-[0_0_2px_rgba(34,211,238,0.5)] font-semibold">
            AI
          </span>{" "}
          and{" "}
          <span className="font-code text-sky-500">Software Engineering</span>
        </h1>
